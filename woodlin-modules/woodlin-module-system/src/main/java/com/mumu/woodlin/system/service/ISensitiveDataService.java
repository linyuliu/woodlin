...
public interface ISensitiveDataService extends IService<SensitiveData> {
     ...
     * @return 分页结果
     */
    PageResult<SensitiveData> searchByNameFuzzy(String keyword, Integer pageNum, Integer pageSize);
     ...
     * @return 分页结果
     */
    PageResult<SensitiveData> searchByMobileFuzzy(String keyword, Integer pageNum, Integer pageSize);
     ...
     * @return 分页结果
     */
    PageResult<SensitiveData> pageSensitiveData(Integer pageNum, Integer pageSize);
