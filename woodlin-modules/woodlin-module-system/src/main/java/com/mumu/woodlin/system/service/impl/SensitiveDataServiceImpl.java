...
public class SensitiveDataServiceImpl extends ServiceImpl<SensitiveDataMapper, SensitiveData> 
     ...
     */
    @Override
    public PageResult<SensitiveData> searchByNameFuzzy(String keyword, Integer pageNum, Integer pageSize) {
        Page<SensitiveData> page = new Page<>(pageNum, pageSize);
        
        if (StrUtil.isBlank(keyword)) {
            return MyBatisPlusPageResults.of(this.page(page));
        }
        
        if (encryptionService.isEmpty()) {
            log.warn("SearchableEncryptionService not available, skipping encrypted search");
            return MyBatisPlusPageResults.of(page);
        }
        ...
        return MyBatisPlusPageResults.of(this.page(page, queryWrapper));
    }
     ...
     */
    @Override
    public PageResult<SensitiveData> searchByMobileFuzzy(String keyword, Integer pageNum, Integer pageSize) {
        Page<SensitiveData> page = new Page<>(pageNum, pageSize);
    ...
    @Override
    public PageResult<SensitiveData> pageSensitiveData(Integer pageNum, Integer pageSize) {
        return MyBatisPlusPageResults.of(this.page(new Page<>(pageNum, pageSize)));
    }
