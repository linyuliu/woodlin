...
CREATE TABLE IF NOT EXISTS sys_sensitive_data (
  data_id BIGINTEGER NOT NULL COMMENT '数据ID',
  ...
  del_flag SMALLINT DEFAULT 0 COMMENT '删除标志（0-未删除，1-已删除）',
  PRIMARY KEY (data_id),
...
-- ALTER TABLE sys_sensitive_data ADD FULLTEXT INDEX ft_real_name_search (real_name_search_index);
-- ALTER TABLE sys_sensitive_data ADD FULLTEXT INDEX ft_mobile_search (mobile_search_index);
