...
(301, 300, '租户列表', 'tenant:list', 'C',
 '/tenant/list', 'tenant/list/index', 'vicons:antd:ClusterOutlined', 1, '1',
 '0','1','1','1',NULL,NULL,'0'),
...
(501, 500, '数据源', 'datasource:list', 'C',
 '/datasource/list', 'datasource/list/index', 'vicons:antd:HddOutlined', 1, '1',
 '0','1','1','1',NULL,NULL,'0'),
...
(601, 600, 'API设计器', 'sql2api:design', 'C',
 '/sql2api/design', 'sql2api/design/index', 'vicons:antd:EditOutlined', 1, '1',
 '0','0','1','1',NULL,NULL,'0'),
...
(901, 900, '生成配置', 'code:generator', 'C',
 '/code/generator', 'code/generator/index', 'vicons:antd:BuildOutlined', 1, '1',
 '0','0','1','1',NULL,NULL,'0'),
