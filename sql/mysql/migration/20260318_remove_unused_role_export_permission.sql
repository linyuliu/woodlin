...
-- 1) 备份受影响数据
-- =========================
DROP TABLE IF EXISTS `bak_20260318_role_export_sys_permission`;
CREATE TABLE `bak_20260318_role_export_sys_permission` LIKE `sys_permission`;
DROP TABLE IF EXISTS `bak_20260318_role_export_sys_role_permission`;
CREATE TABLE `bak_20260318_role_export_sys_role_permission` LIKE `sys_role_permission`;
DROP TABLE IF EXISTS `bak_20260318_role_export_sys_role_inherited_permission`;
CREATE TABLE `bak_20260318_role_export_sys_role_inherited_permission` LIKE `sys_role_inherited_permission`;
