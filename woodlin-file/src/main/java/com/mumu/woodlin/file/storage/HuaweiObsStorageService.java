...
public class HuaweiObsStorageService implements StorageService {
    ...
    public String uploadFile(SysStorageConfig config, String objectKey, InputStream inputStream,
        ...
        try {
            ...
            log.info("华为云OBS上传成功: bucket={}, objectKey={}", config.getBucketName(), objectKey);
            ...
            log.error("华为云OBS上传失败: objectKey={}", objectKey, e);
    ...
    public InputStream downloadFile(SysStorageConfig config, String objectKey) {
        ...
        try {
            ...
            log.error("华为云OBS下载失败: objectKey={}", objectKey, e);
    ...
    public void deleteFile(SysStorageConfig config, String objectKey) {
        ...
        try {
            ...
            log.info("华为云OBS删除成功: bucket={}, objectKey={}", config.getBucketName(), objectKey);
            
        } catch (Exception e) {
            log.error("华为云OBS删除失败: objectKey={}", objectKey, e);
    ...
    public boolean fileExists(SysStorageConfig config, String objectKey) {
        ...
        try {
            ...
            log.error("华为云OBS检查文件存在失败: objectKey={}", objectKey, e);
            return false;
        } finally {
            if (obsClient != null) {
                try {
    ...
    public String generatePresignedUrl(SysStorageConfig config, String objectKey, int expirationTime) {
        ...
        try {
            ...
            log.error("华为云OBS生成预签名URL失败: objectKey={}", objectKey, e);
    ...
    public String generateUploadCredential(SysStorageConfig config, String objectKey, int expirationTime) {
        ...
        try {
            ...
            log.error("华为云OBS生成上传凭证失败: objectKey={}", objectKey, e);
