...
class DictEnumTest {
    ...
    void testGenderDictEnum() {
        ...
        assertEquals("未知的性别", unknown.getLabel());

        Gender notApplicable = Gender.NOT_APPLICABLE;
        assertEquals(9, notApplicable.getValue());
        assertEquals("未说明的性别", notApplicable.getLabel());
    }
