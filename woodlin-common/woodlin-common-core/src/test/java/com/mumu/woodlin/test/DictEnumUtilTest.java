...
public class DictEnumUtilTest {
    ...
    public void testToDictList() {
        ...
        assertEquals(4, genderList.size(), "Gender应该有4个枚举值");
    ...
    public void testToDictMap() {
        ...
        assertEquals(4, genderMap.size(), "Gender应该有4个枚举值");
        assertEquals("男", genderMap.get(1), "value为1应该对应'男'");
        assertEquals("女", genderMap.get(2), "value为2应该对应'女'");
        assertEquals("未知的性别", genderMap.get(0), "value为0应该对应'未知的性别'");
        assertEquals("未说明的性别", genderMap.get(9), "value为9应该对应'未说明的性别'");
    }
    ...
    public void testContainsLabel() {
        ...
        assertTrue(DictUtil.containsLabel(Gender.class, "未知的性别"), "'未知的性别'应该是Gender的有效标签");
        assertTrue(DictUtil.containsLabel(Gender.class, "未说明的性别"), "'未说明的性别'应该是Gender的有效标签");
