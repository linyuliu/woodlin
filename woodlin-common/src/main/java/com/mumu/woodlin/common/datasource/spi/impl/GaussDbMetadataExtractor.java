 ...
 * 华为GaussDB数据库元数据提取器
 * <p>
 * 华为GaussDB数据库基于PostgreSQL开发，是华为自研的企业级数据库。
 ...
 * @since 2025-01-04
 */
public class GaussDbMetadataExtractor extends AbstractPostgreSQLCompatibleExtractor {
    ...
    public boolean supports(Connection conn) throws SQLException {
        ...
        return productName != null && productName.toLowerCase().contains("gauss");
    }
