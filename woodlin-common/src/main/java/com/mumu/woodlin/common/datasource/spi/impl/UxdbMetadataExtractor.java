 ...
 * 优炫数据库元数据提取器
 * <p>
 * 优炫数据库（UXDB）基于PostgreSQL开发，是国产数据库。
 ...
 * @since 2025-01-04
 */
public class UxdbMetadataExtractor extends AbstractPostgreSQLCompatibleExtractor {
    ...
    public boolean supports(Connection conn) throws SQLException {
        ...
        return productName != null && productName.toLowerCase().contains("uxdb");
    }
